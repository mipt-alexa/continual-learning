#!/bin/bash 
#SBATCH --job-name=replay_vit                # Job name
...
python src/main.py --mode $MODE --freeze $FREEZE --model $MODEL --lr $LEARNING_RATE --weight_decay $WEIGHT_DECAY --num_epochs $NUM_EPOCHS
